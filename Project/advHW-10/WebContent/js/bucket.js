...
$.get("buckets", function(data) {
	if (data !== '') {
 	...
 	var tableContent = "<tr class='header'>"+
					...
					"<th style='width: 20%;'>PurchaseTime</th>"+
 	...
 	jQuery.each(buckets, function(i, value) {
 		...
 		tableContent+="<tr>"+
					  ...
					  "<td>" + value.price + "</td>"+
					  "<td>" + value.Purchase_time + "</td>"+
					  "<td><button onclick='deleteOrderFromBucket(" + value.id + ")'>delete</button></td>"+
					  "</tr>"
