		...
		<div class="row">
			...
			<form class="createMagazine">
				<div class="form-group">
					<input type="text" class="form-control magazineTitle"
						placeholder="enter magazine name">
				</div>

				<div class="form-group">
					<input type="text" class="form-control magazineCategory"
						placeholder="enter magazine category">
				</div>

				<div class="form-group">
					<input type="number" class="form-control magazinePrice"
						placeholder="enter magazine price">
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control magazineDescription"
