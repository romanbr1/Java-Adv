magazineId_id<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" magazine-id="${magazine.id}"  class="btn btn-primary buy-product">Buy</button>
				</div>
			</div>
		</div>
	</div>
